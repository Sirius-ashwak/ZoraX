      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 items-center justify-items-center opacity-80">
            {/* Firebase */}
            <div className="flex flex-col items-center gap-4 p-6 rounded-xl hover:bg-muted/50 transition-colors group">
              ...
              <span className="text-sm text-muted-foreground font-semibold">Firebase</span>
            </div>
            ...
            <div className="flex flex-col items-center gap-4 p-6 rounded-xl hover:bg-muted/50 transition-colors group">
              ...
              <span className="text-sm text-muted-foreground font-semibold">Optimism</span>
            </div>
            ...
            <div className="flex flex-col items-center gap-4 p-6 rounded-xl hover:bg-muted/50 transition-colors group">
              ...
              <span className="text-sm text-muted-foreground font-semibold">Zora</span>
            </div>
            ...
            <div className="flex flex-col items-center gap-4 p-6 rounded-xl hover:bg-muted/50 transition-colors group">
              ...
              <span className="text-sm text-muted-foreground font-semibold">Farcaster</span>
            </div>
            ...
            <div className="flex flex-col items-center gap-4 p-6 rounded-xl hover:bg-muted/50 transition-colors group">
              ...
              <span className="text-sm text-muted-foreground font-semibold">IPFS</span>
            </div>
            ...
            <div className="flex flex-col items-center gap-4 p-6 rounded-xl hover:bg-muted/50 transition-colors group">
              ...
              <span className="text-sm text-muted-foreground font-semibold">Uniswap</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-3 gap-12">
            <div className="text-center group">
              <div className="w-20 h-20 bg-gradient-to-br from-purple-500 to-pink-500 rounded-2xl flex items-center justify-center mx-auto mb-8 group-hover:scale-110 transition-transform">
                <Zap className="w-10 h-10 text-white" />
              </div>
              <h3 className="text-2xl font-bold mb-4 text-foreground">Lightning Fast</h3>
              <p className="text-lg text-muted-foreground leading-relaxed">Built with Vite and optimized for instant campaign deployment and real-time analytics.</p>
            </div>
            
            <div className="text-center group">
              <div className="w-20 h-20 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-2xl flex items-center justify-center mx-auto mb-8 group-hover:scale-110 transition-transform">
                <TrendingUp className="w-10 h-10 text-white" />
              </div>
              <h3 className="text-2xl font-bold mb-4 text-foreground">Reputation Driven</h3>
              <p className="text-lg text-muted-foreground leading-relaxed">ZoraCred system builds transparent creator reputation through verified on-chain activity.</p>
            </div>
            
            <div className="text-center group">
              <div className="w-20 h-20 bg-gradient-to-br from-orange-500 to-red-500 rounded-2xl flex items-center justify-center mx-auto mb-8 group-hover:scale-110 transition-transform">
                <Users className="w-10 h-10 text-white" />
              </div>
              <h3 className="text-2xl font-bold mb-4 text-foreground">Community First</h3>
              <p className="text-lg text-muted-foreground leading-relaxed">Farcaster Frame integration enables viral social sharing and community growth.</p>
            </div>
          </div>
        </div>
      </section>
