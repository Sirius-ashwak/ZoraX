      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <Card className="glass-card">
            <CardHeader>
              <CardTitle className="text-white text-xl">Creator Information</CardTitle>
            </CardHeader>
            <CardContent className="text-center py-12">
              ...
              <p className="text-gray-400 mb-6">
                The creator profile system is under development. Soon you'll be able to view 
                reputation scores, campaign history, and ZoraCred achievements.
              </p>
